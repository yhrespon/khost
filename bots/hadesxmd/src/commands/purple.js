...
export default {
    name: "purple",
    description: "Génère un texte style violet (.purple)",
    ...
    async execute(sock, msg, args) {
        ...
        try {
            ...
            console.error("Erreur commande purple:", error);
